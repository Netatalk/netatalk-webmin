...
&header($text{'create_server_header'},"", "intro", 1, 1, undef());
print"<p><p>\n";
...
print "<tr $cb> <td><table>\n";
	...
	print"<tr >";
		...
		print"<td > <input size=10 name=port value=></td>\n";
	...
	print"<tr >";
		...
		print"<td ><input name=setpassword type=radio checked  value=setpassword>$text{'global_ON'}";
			print"<input type=radio name=setpassword value=>$text{'global_OFF'}";
		print"</td>";
		...
		print"<td ><input type=radio checked name=savepassword value=savepassword>$text{'global_ON'}";
			print"<input type=radio name=savepassword value=>$text{'global_OFF'}";
		print"</td>";
	print"</tr>";
	print"<tr >";
